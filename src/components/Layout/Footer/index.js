                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                            <div className="footer-widget__column footer-widget__our-company">
                                ...
                                <ul className="footer-widget__link-list list-unstyled">
                                    <li><Link to="/schedule-list-2">Conference Planning</Link></li>
                                    <li><Link to="/about">Corporate Events</Link></li>
                                    <li><Link to="/about">Wedding Services</Link></li>
                                    <li><Link to="/about">Social Gatherings</Link></li>
                                    <li><Link to="/about">Event Coordination</Link></li>
                                </ul>
                            </div>
                        </div>
        ...
        <div className="site-footer__bottom">
            <div className="container">
                <div className="site-footer__bottom-inner">
                    <p className="site-footer__bottom-text">© Event Management Platform 2024 | All Rights Reserved</p>
